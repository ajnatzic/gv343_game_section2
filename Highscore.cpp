...
/**********************************************************************
 * This file takes a score from a given game and finds where to place the score in "Highscores.txt".
 * The score is placed in the list of Highscores based on the rank of the score. For example,
 * if a score is ranked 3rd, it will be placed in the 3rd line of "Highscores.txt".
 *
 * @author Ben Townsend
 * @date 10-5-2018
 **********************************************************************/
